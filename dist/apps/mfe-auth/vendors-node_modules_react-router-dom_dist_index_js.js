"use strict";
(self["webpackChunkmfeAuth"] = self["webpackChunkmfeAuth"] || []).push([["vendors-node_modules_react-router-dom_dist_index_js"],{
...
// EXTERNAL MODULE: consume shared module (default) react-dom@* (singleton) (fallback: ../../node_modules/react-dom/index.js)
var react_dom_index_js_ = __webpack_require__(33);
var react_dom_index_js_namespaceObject = /*#__PURE__*/__webpack_require__.t(react_dom_index_js_, 2);
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = /*#__PURE__*/index_js_.createElement(index_js_.Fragment, null, /*#__PURE__*/index_js_.createElement("p", null, "\uD83D\uDCBF Hey developer \uD83D\uDC4B"), /*#__PURE__*/index_js_.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /*#__PURE__*/index_js_.createElement("code", {
      style: codeStyles
    }, "ErrorBoundary"), " or", " ", /*#__PURE__*/index_js_.createElement("code", {
      style: codeStyles
...
function RouterProvider(_ref) {
  ...
  index_js_.useEffect(() => logV6DeprecationWarnings(future, router.future), [router, future]);
  ...
  }, state.initialized || router.future.v7_partialHydration ? /*#__PURE__*/index_js_.createElement(DataRoutes, {
...
const flushSyncImpl = react_dom_index_js_namespaceObject[FLUSH_SYNC];
const USE_ID = "useId";
...
function useSearchParams(defaultInit) {
   true ? warning(typeof URLSearchParams !== "undefined", "You cannot use the `useSearchParams` hook in a browser that does not " + "support the URLSearchParams API. If you need to support Internet " + "Explorer 11, we recommend you load a polyfill such as " + "https://github.com/ungap/url-search-params.") : 0;
...
function useViewTransitionState(to, opts) {
  ...
  !(vtContext != null) ?  true ? invariant(false, "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  " + "Did you accidentally import `RouterProvider` from `react-router`?") : 0 : void 0;
  let {
    basename
